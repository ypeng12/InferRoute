...
- **Gateway Overhead P50**: 118.4 ms (Trie lookup + Route classifier)
- **Gateway Overhead P95**: **137.8 ms** (Quality-aware Schema Validation)
- **Gateway Overhead P99**: 146.2 ms (Speculative stream buffer check)
