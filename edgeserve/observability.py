...
REQUEST_LATENCY = Histogram(
    "edgeserve_request_latency_seconds",
...
INTER_TOKEN_LATENCY = Histogram(
    "edgeserve_inter_token_latency_seconds",
...
# Gauges
QUEUE_DEPTH = Gauge(
    "edgeserve_queue_depth",
    "Current active scheduling queue depth",
    ["backend"]
)

# --- OPENTELEMETRY SETUP ---
tracer = trace.get_tracer("edgeserve")
